...
const Result = () => {
  ...
  return (
    <motion.form initial={{opacity:0.2,y:100}} transition={{duration:1}} viewport={{once:true}} whileInView={{opacity:1,y:0}} onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] items-center justify-center '>
    <div>
    ...
    <div className='flex w-full max-w-xl bg-neutral-500 text-white p-0.5 mt-10 rounded-full'>
      <input onChange={e => setInput(e.tarrget.value)} value={input} type="text" placeholder='Describe what you want to generate' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color'/>
